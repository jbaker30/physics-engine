...
const QMetaObject SimNode::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SimNode.data,
      qt_meta_data_SimNode,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SimNode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SimNode.stringdata0))
        return static_cast<void*>(const_cast< SimNode*>(this));
